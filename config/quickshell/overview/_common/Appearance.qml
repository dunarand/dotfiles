...
Singleton {
    ...
    property QtObject defaultColors: QtObject {
        ...
        property color m3primaryContainer: "#9a6ad9"
        property color m3onPrimaryContainer: "#f5e0ff"
        property color m3secondary: "#b4befe"
        property color m3onSecondary: "#1e1e2e"
        property color m3secondaryContainer: "#6e6fbf"
        property color m3onSecondaryContainer: "#e8edff"
